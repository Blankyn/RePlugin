...
public class MainActivity extends Activity {
    ...
    private final String TAG = "HostMainActivity";
...
//                Intent intent = RePlugin.createIntent("com.qihoo360.replugin.sample.demo1", "com.qihoo360.replugin.sample.demo1.MainActivity");
                Intent intent = RePlugin.createIntent("cn.blankm.testplugin", "cn.blankm.testplugin.MainActivity");
                boolean demo1 = RePlugin.startActivity(MainActivity.this, intent);
                Log.w(TAG, "demo1-->" + demo1);
            }
        });
